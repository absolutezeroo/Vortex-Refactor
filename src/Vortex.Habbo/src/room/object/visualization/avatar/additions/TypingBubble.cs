...
/// @see com.sulake.habbo.room.object.visualization.avatar.additions.TypingBubble
public class TypingBubble : IAvatarAddition
{
    private BitmapDataAsset? _asset;
    private AvatarVisualization? _visualization;
    private double _relativeDepth;

    public TypingBubble(int id, AvatarVisualization visualization)
    {
        Id = id;
    ...
    public void Update(IRoomObjectSprite? sprite, double scale)
    {
        ...
        if (scale < 48)
        {
            _asset = _visualization!.GetAvatarRendererAsset("user_typing_small_png") as BitmapDataAsset;
            offsetX = 3;
            offsetY = -42;
            baseSize = 32;
        }
        ...
        {
            _asset = _visualization!.GetAvatarRendererAsset("user_typing_png") as BitmapDataAsset;
            offsetX = 14;
            offsetY = -83;
        }
